              ...
              <form onSubmit={handleSubmit} className="space-y-3.5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 sm:py-3 rounded-xl bg-slate-50 border border-slate-200 focus:bg-white text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#1E9646] focus:ring-2 focus:ring-[#1E9646]/20 text-sm transition-all"
                  />
                </div>
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2.5 sm:py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 focus:outline-none focus:border-[#1E9646] focus:ring-2 focus:ring-[#1E9646]/20 text-sm transition-all flex items-center justify-between text-left cursor-pointer"
                  >
