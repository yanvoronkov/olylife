...
export const PrivacyModal: React.FC<PrivacyModalProps> = ({ isOpen, onClose, city }) => {
  ...
  const lawTitleShort = isBishkek
    ? "Закон Кыргызской Республики № 58 «Об информации персонального характера»"
    : "Закон Республики Узбекистан № ЗРУ-547 «О персональных данных»";

  const lawTitleFull = isBishkek
    ? "Закона Кыргызской Республики от 14 апреля 2008 года № 58 «Об информации персонального характера» (далее — Закон КР № 58)"
    : "Закона Республики Узбекистан от 2 июля 2019 года № ЗРУ-547 «О персональных данных» (далее — Закон № ЗРУ-547)";

  const lawRef = isBishkek ? "Закона КР № 58" : "Закона № ЗРУ-547";
  const countryNameGenitive = isBishkek ? "Кыргызской Республики" : "Республики Узбекистан";
  const countryCode = isBishkek ? "КР" : "РУз";
      ...
      <div className="bg-white border border-slate-200 rounded-3xl max-w-3xl w-full text-slate-900 relative shadow-2xl max-h-[85vh] flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between p-5 sm:p-6 border-b border-slate-100 bg-white/95 backdrop-blur-sm shrink-0 relative z-10">
          <div className="flex items-center gap-3 pr-4">
            ...
            <div>
              ...
              <p className="text-[11px] sm:text-xs text-slate-500">{lawTitleShort}</p>
            </div>
          </div>
        ...
        <div className="p-5 sm:p-8 overflow-y-auto space-y-6 text-xs sm:text-sm text-slate-600 leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p>
              <strong className="text-slate-800">1.1.</strong> Настоящая Политика конфиденциальности (далее – Политика) разработана во исполнение требований {lawTitleFull} и определяет порядок обработки персональных данных и меры по обеспечению их безопасности при использовании настоящего сайта (далее – Сайт).
            </p>
            <p>
            ...
            <p>
              <strong className="text-slate-800">1.3.</strong> В силу {lawRef} Владелец Сайта является Держателем (обладателем) массива персональных данных / Оператором — лицом, осуществляющим сбор, обработку и хранение персональных данных (далее – Оператор).
            </p>
            <p>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside pl-2 space-y-1">
              ...
              <li>Имя пользователя в мессенджерах (Telegram, WhatsApp и др.);</li>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside pl-2 space-y-1">
              ...
              <li>Обеспечение технического контроля, аналитики и соблюдение требований законодательства {countryNameGenitive}.</li>
            </ul>
            <p className="pt-2">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside pl-2 space-y-1">
              ...
              <li>Передавать персональные данные третьим лицам (включая партнеров по проведению акций, демонстраций и мероприятий) в целях реализации условий предоставления услуг и ведения отчетности.</li>
            </ul>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              <strong className="text-slate-800">5.2.</strong> Оператор в соответствии с требованиями законодательства {countryNameGenitive} в области персональных данных обязан прекратить обработку персональных данных и уничтожить их (или обеспечить их уничтожение) в течение установленного законом срока (не позднее 30 дней) с даты получения соответствующего отзыва/запроса от Пользователя.
            </p>
            <p>
              <strong className="text-slate-800">5.3.</strong> В случаях, когда сохранение персональных данных требуется для целей налогового, бухгалтерского учета или соблюдения иного применимого законодательства {countryNameGenitive}, Оператор вправе продолжить хранение персональных данных в объеме и на сроки, строго предусмотренные действующим законодательством {countryCode}.
            </p>
            <p>
          ...
          <section className="space-y-2">
            ...
            <p>
              <strong className="text-slate-800">6.3.</strong> К отношениям между Пользователем и Оператором в сфере обработки персональных данных применяется право {countryNameGenitive}.
            </p>
          </section>
